...
namespace Phongkham.Areas.Admin.Controllers
{
    ...
    public class LichkhamController : Controller
    {
        ...
        public LichkhamController(ApplicationDBcontext context, UserManager<ApplicationUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create(IFormCollection formCollection)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (lichKham != null)
                {
                    ...
                    var message = $"Xin chao, ban co lich kham ngày {ngayDat.ToString("dd/MM/yyyy")}.";
